...
var a, e, i = getApp(), s = i.requirejs("core"), o = i.requirejs("wxParse/wxParse"), n = i.requirejs("biz/diypage"), r = i.requirejs("biz/diyform"), u = i.requirejs("biz/goodspicker"), c = (i.requirejs("foxui"), 
i.requirejs("jquery"));
...
Page((e = {
    ...
    a),
    onShow: function() {
        var t = this, a = t.data.pageid;
        s.get("diypage&id=" + a, {}, function(a) {
            var e = {
                loading: !1,
                diypage: a.diypage
            };
    ...
    onLoad: function(t) {
        ...
        setTimeout(function() {
            ...
            if (void 0 != a.data.startadv && "" != a.data.startadv) {
                ...
                if (1 == e.showtype) {
                    var o = 1e3 * e.showtime * 60, n = i.getCache("startadvtime"), r = +new Date(), u = !0;
                    a.setData({
                        adveradmin: !0
                    }), n && r - n < o && (u = !1), a.setData({
                        adveradmin: u
                    }), u && i.setCache("startadvtime", r);
                }
    ...
    var a = this;
    c.each(this.data.audiosObj, function(e, i) {
        if (e != t) {
            i.pause();
            var s = a.data.audios;
    ...
    e.onPlay(function() {
        var t = setInterval(function() {
            ...
            c[a].audiowidth = i, c[a].Time = t, c[a].audiotime = u, c[a].seconds = r, s.setData({
                audios: c
            });
        }, 1e3);
    });
    ...
    var c = s.data.audios;
    c[a] || (c[a] = {}), e.paused && 0 == n ? (e.src = o, e.play(), 1 == u && (e.loop = !0), 
    c[a].status = !0, s.pauseOther(a)) : e.paused && n > 0 ? (e.play(), 0 == r ? e.seek(n) : e.seek(0), 
    c[a].status = !0, s.pauseOther(a)) : (e.pause(), c[a].status = !1), s.setData({
        audios: c
    });
