    ...
    buyNow: function(t, d, i) {
        ...
        if (n && n.fields.length > 0) {
            ...
            console.log(n.f_data), a.post("order/create/diyform", {
                ...
                console.log(d.data), 0 == d.data.goods.isgift || "goods_detail" != i ? wx.redirectTo({
                    url: "/pages/order/create/index?id=" + d.data.id + "&total=" + d.data.total + "&optionid=" + s + "&gdid=" + t.gdid
        ...
        } else console.log(t), 0 == d.data.goods.isgift || "goods_detail" != i ? wx.redirectTo({
            url: "/pages/order/create/index?id=" + d.data.id + "&total=" + d.data.total + "&optionid=" + s
        }) : "" != c || 1 == d.data.goods.gifts.length ? (1 == d.data.goods.gifts.length && (c = d.data.goods.gifts[0].id), 
        wx.redirectTo({
